...
class AuthWebFilter(
    ...
    override fun filter(exchange: ServerWebExchange, chain: WebFilterChain): Mono<Void> {
        ...
        response.headers.set("Access-Control-Allow-Origin", centralApiProperties.sessionCookieAllowOrigin)
        response.headers.set("Access-Control-Allow-Methods", centralApiProperties.corsAllowedMethods)
        response.headers.set("Access-Control-Allow-Headers", centralApiProperties.corsAllowedHeaders)
...
//
            val sessionToken = request.cookies.getFirst(centralApiProperties.sessionCookieName)?.value
            ...
            return mono {
                ...
                val userID = authSessionService.getUserIdFromSession(sessionToken)
        ...
        return mono {
            ...
            if (authHeader != centralApiProperties.auth) {
                response.statusCode = HttpStatus.UNAUTHORIZED
                return@mono null
            }
